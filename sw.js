const CACHE_NAME='sarasvati-school-v1.4.48';
...
self.addEventListener('fetch',event=>{
 ...
 if(isVersion){event.respondWith(new Response('{"version":"1.4.48","updated":"2026-09-25","notes":"Fix safe two-device Firebase sync with three-way merge and protection against overwriting remote changes."}',{status:200,headers:{'content-type':'application/json; charset=utf-8','cache-control':'no-store'}}));return}
