const CACHE_NAME='sarasvati-school-v1.4.43';
...
self.addEventListener('fetch',event=>{
 ...
 if(isVersion){event.respondWith(new Response('{"version":"1.4.43","updated":"2026-09-25","notes":"Add a safe delete option for marks tests and their related marks."}',{status:200,headers:{'content-type':'application/json; charset=utf-8','cache-control':'no-store'}}));return}
