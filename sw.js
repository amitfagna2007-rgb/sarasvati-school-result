const CACHE_NAME='sarasvati-school-v1.4.39';
...
self.addEventListener('fetch',event=>{
 ...
 if(isVersion){event.respondWith(new Response('{"version":"1.4.39","updated":"2026-09-25","notes":"Restored fuller recovery data and protected against partial cloud snapshots."}',{status:200,headers:{'content-type':'application/json; charset=utf-8','cache-control':'no-store'}}));return}
