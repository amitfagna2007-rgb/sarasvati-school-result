const CACHE_NAME = 'sarasvati-school-v1.4.8';
...
self.addEventListener('fetch', event => {
  ...
  if(isVersion){
    event.respondWith(new Response('{"version":"1.4.8","updated":"2026-09-17","notes":"Added Health and Physical Education and Art Education to report-card subjects"}',{status:200,headers:{'content-type':'application/json; charset=utf-8','cache-control':'no-store'}}));
    return;
  }
  if(isIndex){
