const CACHE_NAME='sarasvati-school-v1.4.46';
...
self.addEventListener('fetch',event=>{
 ...
 if(isVersion){event.respondWith(new Response('{"version":"1.4.46","updated":"2026-09-25","notes":"Keep result serial numbers sequential and fixed after rank sorting; roll number and student details move with the ranked student."}',{status:200,headers:{'content-type':'application/json; charset=utf-8','cache-control':'no-store'}}));return}
