const CACHE_NAME = 'sarasvati-school-v1.4.21';
...
self.addEventListener('fetch', event => {
  ...
  if(isVersion){
    event.respondWith(new Response('{"version":"1.4.21","updated":"2026-09-18","notes":"Fixed Report Card exam selector and Marksheet rendering"}',{status:200,headers:{'content-type':'application/json; charset=utf-8','cache-control':'no-store'}}));
    return;
  }
  if(isIndex){
